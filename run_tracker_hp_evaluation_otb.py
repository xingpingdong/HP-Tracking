...
# from make_models_no_stride import make_models_fixed

from get_paths import get_paths
data_paths = get_paths('./')
dataset_folder = data_paths.OTB_path#'/media/dxp/DATA/datasets/OTB/'
...
def main():
    ...
    mu_model = load_model('models/mu_model.h5')
    ...
    gym_env = Env(low_hp, scale_range, min_range, max_range, 'u5')

    # iterate through all videos of evaluation.dataset
    if evaluation.video == 'all':
        # dataset_folder = os.path.join(env.root_dataset, evaluation.dataset)
        # dataset_folder = '/home/cgv841/dxp/datasets/OTB-2013/'
        ...
        for i in range(nv):
            # print videos_list[i]
            gt, frame_name_list, frame_sz, n_frames = _init_video(videos_list[i])
...
def _init_video(video):
    ...
    # dataset_folder = '/home/cgv841/dxp/datasets/OTB'
    # if video == "Jogging1":
    #     video = "Jogging"
